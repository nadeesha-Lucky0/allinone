...
export default function BudgetTracker({ budgetItems, onAdd, onUpdate, onDelete }) {
  ...
  const categories = ['all', 'Venue', 'Catering', 'Attire', 'Music', 'Photography', 'Decor', 'Other'];
      ...
      <div className="stats-grid" style={{ marginBottom: '2.5rem' }}>
        <div className="luxury-card stat-card">
          ...
          <div className="stat-info">
            ...
            <div className="stat-lbl">Estimated Budget</div>
          </div>
        </div>

        <div className="luxury-card stat-card">
          <div className="stat-icon" style={{ background: 'rgba(182, 152, 90, 0.12)', color: 'var(--warning)' }}>
            <DollarSign size={24} />
          </div>
          <div className="stat-info">
            <div className="stat-val">${totalActual.toLocaleString()}</div>
            <div className="stat-lbl">Total Actual Cost</div>
          </div>
        </div>
        ...
        <div className="luxury-card stat-card">
          ...
          <div className="stat-info">
            ...
            <div className="stat-lbl">Total Paid to Date</div>
          </div>
        </div>
              ...
              {filteredItems.length === 0 && (
                <tr>
                  <td colSpan="8" style={{ textAlign: 'center', padding: '3rem', color: 'var(--text-muted)' }}>
                    No expense entries found. Click Add Expense to register!
                  </td>
                </tr>
              )}
            </tbody>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                <div className="form-group" style={{ gridColumn: 'span 2' }}>
                  ...
                  <input
                    ...
                    placeholder="e.g., Catering Deposit, Wedding Florist"
                    value={itemName}
                ...
                <div className="form-group">
                  <label>Actual Incurred Cost ($)</label>
                  <input
                    type="number"
                    min="0"
                    className="form-control"
                ...
                <div className="form-group" style={{ gridColumn: 'span 2' }}>
                  <label>Paid Amount to Date ($)</label>
                  <input
                    type="number"
                    min="0"
                    className="form-control"
